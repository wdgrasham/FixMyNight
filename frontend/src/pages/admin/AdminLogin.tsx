...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const data = await api<TokenResponse>('/api/v1/auth/admin-login', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top half — white background with full logo */}
      <div className="relative bg-white flex-1 flex items-end justify-center pb-12 pt-20">
        ...
        <div className="relative flex flex-col items-center">
          <Link to={ROUTES.FIXMYNIGHT_PRODUCT}>
            <img src="/FixMyNightLogo.png" alt="FixMyNight" width="450" height="auto" className="max-w-full object-contain" />
          </Link>
      ...
      {/* Bottom half — dark navy with sign-in form */}
      <div className="relative bg-[#0F172A] flex-1 flex items-start justify-center pt-8 pb-12 -mt-px">
        ...
        <div className="relative w-full max-w-sm px-6">
          <div className="rounded-2xl border border-[#1E293B] bg-[#1E293B]/60 backdrop-blur-sm p-8 shadow-xl">
            ...
            <p className="text-sm text-[#94A3B8] mb-6">Enter your admin password to continue.</p>
