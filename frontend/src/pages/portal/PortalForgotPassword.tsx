...
export default function PortalForgotPassword() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await api('/api/v1/auth/portal-forgot-password', {
        method: 'POST',
          ...
          <div className="rounded-2xl border border-[#1E293B] bg-[#1E293B]/60 backdrop-blur-sm p-8 shadow-xl">
            {sent ? (
              ...
              <>
                ...
                <p className="text-sm text-[#94A3B8] mb-6">
                  Enter the email address associated with your FixMyNight account.
                </p>
                ...
                <p className="mt-4 text-xs text-[#64748B] text-center">
                  <Link to={ROUTES.PORTAL_ENTRY} className="text-[#F59E0B] hover:text-[#D97706] transition-colors">
                    Back to login
                  </Link>
                </p>
              </>
